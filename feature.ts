import {Feature as BaseFeature, GeoJsonObject, GeoJsonProperties, Geometry, LineString, Point} from 'geojson';
...
// Eventuali proprietà aggiuntive per la collezione
  }

export interface WmProperties extends GeoJsonProperties {
    app_id: string;
    created_at: string;
    id: number;
    rawData: {
